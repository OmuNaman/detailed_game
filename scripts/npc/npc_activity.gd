...
const JOB_OBJECT_STATES: Dictionary = {
	...
	"Innkeeper": "managing the inn",
	"Cook": "cooking meals",
	"Merchant": "selling goods",
	"Carpenter": "crafting wood",
	"Woodcutter": "sorting lumber",
	"Tailor": "sewing fabric",
	"Seamstress": "embroidering",
	"Stablehand": "tending horses",
	...
	"Brewer": "brewing ale",
	"Nun": "praying",
	"Deacon": "maintaining the church",
	"Scribe": "copying documents",
	"Miner": "sorting ore",
	"Fisherman": "cleaning fish",
	"Handyman": "fixing things",
	"Baker's Apprentice": "kneading dough",
	"Laborer": "hauling goods",
	"Weaver": "weaving cloth",
	"Courier": "sorting deliveries",
	"Woodsman": "checking supplies",
	"Housewife": "volunteering",
	"Undertaker": "updating records",
	"Beekeeper": "selling honey",
	"Bouncer": "watching the door",
	"Dancer": "practicing",
	"Gardener": "selling vegetables",
	"Midwife": "checking on patients",
}
